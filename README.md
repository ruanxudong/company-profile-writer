...
```bash
git clone https://github.com/<owner>/company-profile-writer.git
mkdir -p ~/.codex/skills/company-profile-writer
cp -R company-profile-writer/company-profile-writer/. ~/.codex/skills/company-profile-writer/
```

Claude Code：

```bash
mkdir -p ~/.claude/skills/company-profile-writer
cp -R company-profile-writer/company-profile-writer/. ~/.claude/skills/company-profile-writer/
```
...
- [Skill 主流程](company-profile-writer/SKILL.md)
- [初创企业公司简介方法论](company-profile-writer/references/startup-profile-framework.md)
- [高端 / 成熟企业公司简介方法论](company-profile-writer/references/enterprise-profile-framework.md)

## 文件结构

```text
company-profile-writer-main/
├── README.md
├── assets/
│   └── readme/
│       └── hero.svg
...
当前发布包未包含 license 文件。公开发布或分发前建议补充明确许可证。
